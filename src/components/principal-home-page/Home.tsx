    ...
    <div>
      ...
      <div className="text-center">
        <section className="flex flex-col items-center">
          <h1 className="text-center mt-16 mb-6 text-4xl font-extrabold text-white">
            Welcome to PokéApp
          </h1>
          <div className="m-auto laptop:mb-20 w-11/12 grid grid-col-full gap-6 laptop:grid-cols-gifs items-center">
            <img
              className="m-auto w-48 laptop:ml-8 mobile:w-72 h-auto"
              src={charizard}
              alt="POKEMON"
            />
            ...
            <img
              className="m-auto mb-4 w-48 laptop:ml-8 mobile:w-72 h-auto"
              src={ivysaur}
              alt="POKEMON"
            />
          </div>
